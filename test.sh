...
assert 1 "int main(){int a =5; if (a <= 5) return a = 1; return 2;}"
assert 3 "int main(){int a=5; int b; if (a) a = 1; b = a + 2; return b;}"
assert 7 "int main(){int a=5; if (a < 5) {a = 1;} else {a = 3;} return a + 4;}"

assert 5 "int main(){int i=2; while(i < 5) {i = i + 1;} return i;}"
assert 10 "int main(){int i=10; while(i < 5) {i = i + 1;} return i;}"
