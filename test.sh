...
assert 10 "main(){foo = bar = 1; return foo + bar + 8;}"
assert 14 "main(){foo = 2; bar = foo + 3; baz = (foo + bar) * foo; return baz;}"
assert 1 "main(){foo = 1; bar = foo + 2; return bar < 4;}"

assert 1 "main(){a =5; if (a <= 5) return a = 1; return 2;}"
assert 3 "main(){a =5; if (a) a = 1; b = a + 2; return b;}"
assert 7 "main(){a =5; if (a < 5) {a = 1;} else {a = 3;} return a + 4;}"
